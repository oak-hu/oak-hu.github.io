...
Remark on Question 2.6: Some professional logicians have gotten this wrong in conversation, apparently! It's a very cute question. Unexplored area of logic: what rules can you add to a system of logic containing all tautologies as axioms to make the system complete? Clearly, (MP) works, (MT) fails, and ($\land$Intro) obviously fails. (Project?)
