...
As noted, counterfactual conditionals seem to compose ‘would’ with $$(X \rightarrow Y)$$. There are (at least) two distinct ways to compose these operators, with ‘would’ taking either wide scope or narrow scope:

> (6) would$$(X \rightarrow Y)$$
>
> (7) X $$\rightarrow$$ would(Y)
