...
> The following is a tutorial essay for Philosophy of Logic and Language with James Kirkpatrick. It addresses the prompt: ‘According to Kaplan, indexicals and demonstratives have both content and character. Explain this distinction and how it might help capture the meaning of these terms.’ A free-standing and much more readable version of some of the material may eventually go up on my [Substack](https://offhandquibbles.substack.com/).
...
The content of what Ann says is the proposition that she smokes. This proposition might be true or false if different possibilities were the case—call these possibilities the _circumstances of evaluation_.
...
The first is _extreme homonymy_, in Dorr’s (2014) terminology. The thought is that Ann’s ‘I’ and Ben’s ‘I’ are two different words. We have a whole family of words, all written (and more or less pronounced) identically, just like ‘bank’ (meaning a riverbank) and ‘bank’ (meaning a financial bank). We will return to this option later.

The second option is to say that the same word ‘I’ can have different meanings depending on the _context of utterance_. The word ‘I’ has a fixed _character_ which, roughly, is a function from contexts of utterance to contents (Kaplan 1989; see also Braun 1995). At first pass, ‘I’ maps to the speaker of the utterance. Of course, there are anomalies—what if Ann is acting as a translator for someone saying <cjk>我抽烟</cjk> (‘I smoke’)? Maybe then the relevant speaker is somehow the original speaker; or maybe Ann is saying the quote-name of the sentence ‘I smoke’ rather than the sentence itself; or maybe the content of Ann’s utterance is that she smokes while what she somehow communicates is that the original speaker smokes. Still, even without working out the character of ‘I’ in detail—or even working out in detail what contexts are—we have enough to state the distinction between content and character. The _content_ of an utterance or sentence in a context is the semantic value: an individual for ‘I’, a monadic property for ‘smoke’, and a proposition for ‘I smoke’. (What these turn out to be is unimportant for now; Kaplan works primarily in terms of extensions at worlds, but we could take the contents as more or less primitive themselves.) Meanwhile, the _character_ of an utterance of a sentence in a context is simply the character of that sentence in any context; this character is what maps the context to the content.
...
However, for _indexicals_ (which must be supplied an index by the context) and _demonstratives_ (which must be supplied a demonstration by the context), the context does seem to change the content, and so we must invoke character. The list Kaplan (1989) provides includes:
